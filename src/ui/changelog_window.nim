  ...
  ChangelogVersion(
    ...
    entries: @[
      ...
      ChangelogEntry(category: clcImproved,
        ...
        es: "Todas las auras ganaron alcance: los radios base pasaron de 188/250/313 a 250/325/400, y cada aura toma una porcion distinta de esa banda para que las auras apiladas se lean como anillos concentricos diferenciados."),
      ChangelogEntry(category: clcImproved,
        ...
        es: "Las auras apiladas ya no disparan en el mismo fotograma: cada una tiene su propio temporizador y arranca desfasada, asi que los pulsos llegan repartidos en vez de todos a la vez."),
      ChangelogEntry(category: clcImproved,
      ...
      ChangelogEntry(category: clcImproved,
        ...
        es: "El Aura de Viento ahora es una ráfaga periodica que empuja a los enemigos, y el Campo de Ralentizacion pasa a ser un pulso ralentizador."),
      ChangelogEntry(category: clcImproved,
        en: "Element masteries now also make their aura pulse faster, not just hit harder.",
        es: "Las maestrias elementales ahora tambien hacen que su aura pulse mas rapido, no solo que pegue mas fuerte."),
      ChangelogEntry(category: clcImproved,
        ...
        es: "Reiniciar desde la oleada 1 teniendo un punto de control ahora pide confirmacion, para que una tecla por reflejo no tire la partida a la basura."),
      ChangelogEntry(category: clcImproved,
        en: "Game-over buttons are colour-coded: green for continuing, red for leaving.",
        es: "Los botones de la pantalla de derrota estan codificados por color: verde para continuar, rojo para salir."),
      ChangelogEntry(category: clcImproved,
        ...
        es: "Las partidas retomadas ahora restauran mas de tu build: las compras de tienda (para que precios y mejoras mantengan su curva), el tamaño extra de Balas Pesadas y el registro del bono de remontada."),
      ChangelogEntry(category: clcImproved,
      ...
      ChangelogEntry(category: clcBalance,
        ...
        es: "Maestria de Fuego reducida de +350% a +150% de daño, ahora en linea con las demas maestrias elementales."),
      ChangelogEntry(category: clcBalance,
        ...
        es: "Maestria de Escarcha rehecha como opcion de control puro: +25% de ralentizacion (hasta 85%) y orbes que enfrian un 55%, en vez de daño y duracion extra."),
      ChangelogEntry(category: clcBalance,
        en: "Arcane Mastery simplified: +75% damage to everything arcane, and arcane bullets still pierce.",
        es: "Maestria Arcana simplificada: +75% de daño a todo lo arcano, y las balas arcanas siguen perforando."),
      ChangelogEntry(category: clcBalance,
        en: "Wind Mastery now grants +45% slow and a 3.5x stronger push.",
        es: "Maestria de Viento ahora otorga +45% de ralentizacion y un empuje 3.5 veces mas fuerte."),
      ChangelogEntry(category: clcBalance,
        ...
        es: "Los puntos debiles de los jefes recompensan un poco menos: sus multiplicadores de daño se recortaron en todos los niveles de jefe, asi que reventar un punto debil ya no se salta fases enteras."),
      ChangelogEntry(category: clcBalance,
        ...
        es: "Los jefes reciben menos daño mientras canalizan un mega especial (30% del normal, antes 40%), asi que ya no basta con correr contra sus grandes conjuros."),
      ChangelogEntry(category: clcBalance,
        ...
        es: "El Arquitecto Laser vuelve a leerse mejor: preparacion mas ajustada del rayo de rebote, barrido mas rapido, un rayo menos en la jaula prismatica, laseres de francotirador mas debiles y un ataque de proyectiles menos en su ultima fase."),
      ChangelogEntry(category: clcBalance,
        ...
        es: "La fase final del Caminante del Vacio cambia daño por defensa: pega mas flojo y lanza menos proyectiles, pero es mucho mas dificil de fundir."),
      ChangelogEntry(category: clcBalance,
        ...
        es: "Regeneracion rehecha para escalar con tu vida: ahora cura una cantidad fija mas una parte de tu vida máxima en cada oleada (150 HP +3%, 250 HP +5%, 350 HP +7%), como los botiquines, en vez de una tirada fija que se quedaba corta al final."),
      ChangelogEntry(category: clcBalance,
        ...
        es: "Las ofertas de potenciadores se reajustaron al ciclo de jefes: ahora recibes una seleccion en cada oleada del bloque salvo la primera, mas la recompensa garantizada del jefe."),
      ...
      ChangelogEntry(category: clcFixed,
        ...
        es: "Se corrigio que los botones de jefes del Sandbox invocaran al jefe equivocado (o a ninguno)."),
      ChangelogEntry(category: clcFixed,
  ...
  ChangelogVersion(
    ...
    entries: @[
      ...
      ChangelogEntry(category: clcNew,
        ...
        es: "Nuevo diseño de HUD panoramico 16:9 que mueve la interfaz a paneles laterales, intercambiable en Ajustes junto al diseño clasico 4:3."),
      ChangelogEntry(category: clcNew,
      ...
      ChangelogEntry(category: clcNew,
        ...
        es: "Ventana de configuracion del Sandbox: arma un equipamiento a medida, elige un preajuste desde Inicio hasta Fin de Partida (oleada 60), o carga la build media de cualquier oleada."),
      ChangelogEntry(category: clcNew,
        ...
        es: "Pantalla de victoria del Roguelite y bucle infinito: derrota a todos los jefes de piso y luego cobra tu botin o desciende de nuevo por mejores recompensas y procesos mas feroces."),
      ChangelogEntry(category: clcNew,
        en: "Roguelite and Survival now have their own ending cinematics, closing out the story each mode tells.",
        es: "Roguelite y Supervivencia ahora tienen sus propias cinematicas finales, cerrando la historia que cuenta cada modo."),
      ChangelogEntry(category: clcNew,
        en: "New Cinematics tab in Settings: replay any story cinematic or mode intro whenever you want.",
        es: "Nueva pestaña de Cinematicas en Ajustes: vuelve a ver cualquier cinematica de historia o intro de modo cuando quieras."),
      ChangelogEntry(category: clcNew,
        ...
        es: "Paquetes tematicos de cosmeticos: la nueva pestaña PACKS de la tienda vende trios de jugador, bala y particulas a juego con 40% de descuento, y solo te cobra las piezas que aun no tienes."),
      ChangelogEntry(category: clcNew,
        en: "New cosmetics: Starfall and Storm Surge player and bullet skins, plus Crystal Bloom and Code Rain particle effects.",
        es: "Nuevos cosmeticos: aspectos de jugador y bala Starfall y Storm Surge, mas los efectos de particulas Crystal Bloom y Code Rain."),
      ChangelogEntry(category: clcNew,
      ...
      ChangelogEntry(category: clcNew,
        ...
        es: "Nuevas mecanicas de enemigos y jefes: cortafuegos de fase, enemigos sellados que debes limpiar antes de que la pelea continue, y estados de sobrecarga que castigan disparar sin parar."),
      ChangelogEntry(category: clcNew,
        en: "New ricochet laser boss ultimate that bounces around the arena.",
        es: "Nueva ultimate de jefe con laser de rebote que va rebotando por el escenario."),
      ChangelogEntry(category: clcNew,
      ...
      ChangelogEntry(category: clcNew,
        ...
        es: "Mas cosmeticos, incluyendo aspectos tematicos de D&D y sombreros secretos desbloqueables."),
      ...
      ChangelogEntry(category: clcImproved,
        ...
        es: "Cuatro potenciadores rehechos con identidades propias y renombrados: Sobrecarga (manten el disparo para acelerar la cadencia hasta +30%), Coloso (+2% de daño por cada 100 HP maximos, hasta +40%), Impulso (hasta +25% de daño en movimiento) y Lightspeed (cada disparo lanza un rayo trazador instantaneo por 50% de daño)."),
      ChangelogEntry(category: clcImproved,
        ...
        es: "Fuego y veneno ahora se juegan distinto: el fuego golpea de golpe, el veneno gotea y se acumula con el tiempo, y cada uno muestra sus propios numeros de daño."),
      ChangelogEntry(category: clcImproved,
        en: "Bosses 1, 2, 3, 5 and 7 through 12 all received reworks or retunes, giving each one a clearer signature attack.",
        es: "Los jefes 1, 2, 3, 5 y del 7 al 12 recibieron reworks o reajustes, dando a cada uno un ataque caracteristico mas claro."),
      ChangelogEntry(category: clcImproved,
      ...
      ChangelogEntry(category: clcImproved,
        ...
        es: "Ventana de logros renovada con progreso mas claro y mejor organizacion."),
      ChangelogEntry(category: clcImproved,
        ...
        es: "Mejoras de calidad de vida en Roguelite: mapa de sectores mas claro, un aviso antes del punto sin retorno en el piso final, y un resumen de reliquias al abandonar la partida."),
      ChangelogEntry(category: clcImproved,
      ...
      ChangelogEntry(category: clcImproved,
        ...
        es: "Tienda e instalador de potenciadores redistribuidos para encajar correctamente en el diseño panoramico."),
      ChangelogEntry(category: clcImproved,
      ...
      ChangelogEntry(category: clcBalance,
        ...
        es: "Escalado de fin de partida reajustado: la cantidad de enemigos crece en una curva mas suave y sin tope y los enemigos (y los jefes infinitos pasada la oleada 60) ganan vida y daño acumulativos, mientras que los enemigos normales se moderaron para que las oleadas profundas dependan de jefes y elites en vez del desgaste constante."),
      ChangelogEntry(category: clcBalance,
        ...
        es: "Maestrias elementales reajustadas con la nueva division de fuego y veneno: Maestria de Fuego otorga +350% de daño, +50% de duracion y +45% de ralentizacion, y Maestria de Veneno otorga +150% de daño, +200% de duracion y +40% de ralentizacion."),
      ChangelogEntry(category: clcBalance,
      ...
      ChangelogEntry(category: clcBalance,
        ...
        es: "La curacion ahora se atribuye a tu multiplicador de curacion, asi que las estadisticas de curacion cuadran correctamente."),

      # --- Fixes ---
      ChangelogEntry(category: clcFixed,
        en: "Fixed bosses occasionally dying at random.",
        es: "Se corrigio que los jefes murieran al azar en ocasiones."),
      ChangelogEntry(category: clcFixed,
        en: "Fixed thunderstrike and void rift warnings spawning incorrectly.",
        es: "Se corrigio que los avisos de rayo y de grietas del vacio aparecieran de forma incorrecta."),
      ChangelogEntry(category: clcFixed,
        en: "Fixed Pulse Armor and orbital cube behaviour.",
        es: "Se corrigio el comportamiento de la Armadura de Pulso y del cubo orbital."),
      ChangelogEntry(category: clcFixed,
        en: "Fixed the Survival timer being drawn in the wrong position.",
        es: "Se corrigio que el temporizador de Supervivencia se dibujara en la posicion equivocada."),
      ChangelogEntry(category: clcFixed,
      ...
      ChangelogEntry(category: clcFixed,
        ...
        es: "Se corrigieron errores del sistema de desbloqueos, ademas de varios arreglos en ajustes, panel de depuracion y HUD.")
    ]
  )
]
