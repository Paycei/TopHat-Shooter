    ...
    entries: @[
      ...
      ChangelogEntry(category: clcNew,
        ...
        en: points(
          ...
          "The desktop icon is now RECOVERY.exe, and the unlock and loading messages call the mode Deep Recovery."),
        es: points(
          ...
          "El icono del escritorio ahora es RECOVERY.exe, y los mensajes de desbloqueo y de carga llaman al modo Recuperación Profunda.")),
      ChangelogEntry(category: clcNew,
      ...
      ChangelogEntry(category: clcNew,
        headEn: "Roguelite and Time Survival: restore points",
        headEs: "Roguelite y Supervivencia: puntos de restauración",
        en: points(
          "The roguelite and Time Survival now have restore points too: 3 on Easy, 1 on Normal, none on Hard or Nightmare.",
          "In the roguelite, each sector saves one as you enter it. After a death, CONTINUE (SECTOR N) spends a restore point and puts you back at the start of that sector with your build, patches and Heat as they were when you entered it.",
          "In Time Survival, each boss you beat saves one once you have picked its reward. CONTINUE (5:00) puts you back at that moment on the survival clock, with the boss's Kernel cache still waiting on the floor.",
          "The shards and Cores a roguelite death banks stay banked. Continuing does not pay them out a second time.",
          ...
          "Like endless waves, the roguelite's endless loop and Survival's Overtime have no restore points: one death ends the run, and the victory screens warn you before you go on. The Long Watch ending now waits until a survival run is truly over."),
        es: points(
          "El roguelite y Supervivencia ahora también tienen puntos de restauración: 3 en Fácil, 1 en Normal y ninguno en Difícil ni en Pesadilla.",
          "En el roguelite, cada sector guarda uno al entrar en él. Tras una muerte, CONTINUAR (SECTOR N) gasta un punto de restauración y te devuelve al principio de ese sector con tu build, tus parches y tu Calor tal como estaban al entrar.",
          "En Supervivencia, cada jefe que derrotas guarda uno en cuanto eliges su recompensa. CONTINUAR (5:00) te devuelve a ese momento del reloj de supervivencia, con la caché del Kernel del jefe todavía esperando en el suelo.",
          "Los fragmentos y Núcleos que guarda una muerte en el roguelite siguen guardados. Continuar no te los vuelve a pagar.",
          ...
          "Como en las oleadas infinitas, el bucle infinito del roguelite y el tiempo extra de Supervivencia no tienen puntos de restauración: una muerte termina la partida, y las pantallas de victoria te avisan antes de seguir. El final de La Larga Vigilia ahora espera a que la partida de supervivencia termine de verdad.")),
      ChangelogEntry(category: clcNew,
