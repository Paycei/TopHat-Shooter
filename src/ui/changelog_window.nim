  ...
  ChangelogVersion(
    ...
    entries: @[
      ...
      ChangelogEntry(category: clcNew,
        ...
        es: "Nuevo bono de remontada: quedar atras otorga un aumento temporal de dano para ayudarte a recuperar."),
      ChangelogEntry(category: clcNew,
      ...
      ChangelogEntry(category: clcBalance,
        ...
        es: "Orbes Arcanos reforzados: +50% de dano base. Hacen dano puro sin efecto elemental, asi que ahora pegan notablemente mas fuerte para compensar."),
      ChangelogEntry(category: clcBalance,
        en: "Poison and Fire orb masteries strengthened: stronger damage-over-time and a heavier slow on affected enemies.",
        es: "Maestrias de orbe de Veneno y Fuego reforzadas: mas dano por tiempo y una ralentizacion mas fuerte sobre los enemigos afectados."),
      ChangelogEntry(category: clcBalance,
        ...
        es: "Se rehizo el escalado de fin de partida: la cantidad de enemigos ahora crece en una curva mas suave y sin tope, mientras que los enemigos (y los jefes infinitos pasada la oleada 60) ganan vida y dano acumulativos, manteniendo el desafio en las oleadas infinitas."),
      ChangelogEntry(category: clcBalance,
