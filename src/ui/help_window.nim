...
proc executeCommand*(help: HelpWindow, cmd: string) =
  ...
  try:
    ...
    of "powerups":
      ...
      help.addOutput("  " & t(tkHelpDamageZone), White)
      ...
      help.addOutput("  " & t(tkHelpBulletDamage), White)
    ...
    of "shop":
      ...
      help.addOutput("", White)
      help.addOutput("  " & t(tkHelpShopWallX5), White)
      help.addOutput("    " & t(tkHelpShopWallX5Desc), White)
      help.addOutput("", White)
