...
type
  ...
  TranslationKey* = enum
    ...
    tkShopWallX5 = "shop_wall_x5"
    tkShopWallX5Desc = "shop_wall_x5_desc"
...
var translations: Table[localization.Language, Table[system.string, system.string]] = {
  English: {
    ...
    "shop_wall_x5": "Wall (x5)",
    "shop_wall_x5_desc": "Buy 5 deployable walls",
    ...
    "powerup_rotating_shield_desc1": "3 shields (30% coverage, 3 HP, 4s respawn)",
    "powerup_rotating_shield_desc2": "3 shields (35% coverage, 4 HP, 3s respawn)",
    "powerup_rotating_shield_desc3": "3 shields (40% coverage, 5 HP, 2s respawn)",
    "powerup_damage_zone_desc1": "3 dmg/sec in 120 radius",
    "powerup_damage_zone_desc2": "6 dmg/sec in 160 radius",
    "powerup_damage_zone_desc3": "12 dmg/sec in 200 radius",
    ...
    "powerup_explosive_bullets_desc1": "Bullets explode (small radius)",
    "powerup_explosive_bullets_desc2": "Bullets explode (medium radius)",
    "powerup_explosive_bullets_desc3": "Bullets explode (large radius)",
    ...
    "powerup_poison_shot_desc1": "Bullets poison (0.5 dmg/s, 4s)",
    "powerup_poison_shot_desc2": "Bullets poison (1 dmg/s, 5s)",
    "powerup_poison_shot_desc3": "Bullets poison (2 dmg/s, 6s)",
    "powerup_fire_bullets_desc1": "Bullets burn (0.3 dmg/s, 2s)",
    "powerup_fire_bullets_desc2": "Bullets burn (0.75 dmg/s, 3s)",
    "powerup_fire_bullets_desc3": "Bullets burn (1.5 dmg/s, 4s)",
    ...
    "powerup_fire_aura_desc1": "Burn enemies 1.5 dmg/s in 120 radius (2s)",
    "powerup_fire_aura_desc2": "Burn enemies 3 dmg/s in 160 radius (3s)",
    "powerup_fire_aura_desc3": "Burn enemies 6 dmg/s in 200 radius (4s)",
    "powerup_lightning_aura_desc1": "Zap 0.8 dmg/s in 120 radius (chains 1x)",
    "powerup_lightning_aura_desc2": "Zap 1.6 dmg/s in 160 radius (chains 2x)",
    "powerup_lightning_aura_desc3": "Zap 3.2 dmg/s in 200 radius (chains 3x)",
    "powerup_poison_aura_desc1": "Poison 0.6 dmg/s in 120 radius (6s duration)",
    "powerup_poison_aura_desc2": "Poison 1.2 dmg/s in 160 radius (8s duration)",
    "powerup_poison_aura_desc3": "Poison 2.4 dmg/s in 200 radius (10s duration)",
    ...
    "powerup_time_warp_desc": "Slow time 50% for 4s (2 uses/wave, 18s cd)",
    ...
    "powerup_overcharge_desc": "+5% dmg per 100 units traveled (max 100%, 80 range)",
    "powerup_echo_shots_desc": "Bullets leave ghost trail (50% dmg)",
    "powerup_rotating_orbs_desc": "All 6 elemental orbs (2.5 dmg/hit)",
    "powerup_poison_orb_desc1": "2 poison orbs (0.3 dmg/s)",
    "powerup_poison_orb_desc2": "4 poison orbs (0.3 dmg/s)",
    "powerup_poison_orb_desc3": "6 poison orbs (0.3 dmg/s)",
    "powerup_fire_orb_desc1": "2 fire orbs (0.4 dmg/s)",
    "powerup_fire_orb_desc2": "4 fire orbs (0.4 dmg/s)",
    "powerup_fire_orb_desc3": "6 fire orbs (0.4 dmg/s)",
    "powerup_lightning_orb_desc1": "2 lightning orbs (1.5 dmg/hit)",
    "powerup_lightning_orb_desc2": "4 lightning orbs (2 dmg/hit)",
    "powerup_lightning_orb_desc3": "6 lightning orbs (2.5 dmg/hit)",
    "powerup_wind_orb_desc1": "2 wind orbs (1 dmg/hit, push)",
    "powerup_wind_orb_desc2": "4 wind orbs (1.5 dmg/hit, push)",
    "powerup_wind_orb_desc3": "6 wind orbs (2 dmg/hit, push)",
    "powerup_frost_orb_desc1": "2 frost orbs (1 dmg/hit, slow)",
    "powerup_frost_orb_desc2": "4 frost orbs (1.5 dmg/hit, slow)",
    "powerup_frost_orb_desc3": "6 frost orbs (2 dmg/hit, slow)",
    "powerup_arcane_orb_desc1": "2 arcane orbs (1.5 dmg/hit, arcane)",
    "powerup_arcane_orb_desc2": "4 arcane orbs (2 dmg/hit, arcane)",
    "powerup_arcane_orb_desc3": "6 arcane orbs (2.5 dmg/hit, arcane)",
    "powerup_arcane_bullets_desc1": "Bullets enhanced with arcane power (+50% bullet damage, arcane)",
    "powerup_arcane_bullets_desc2": "Bullets enhanced with arcane power (+100% bullet damage, arcane)",
    "powerup_arcane_bullets_desc3": "Bullets enhanced with arcane power (+150% bullet damage, arcane)",
    "powerup_arcane_aura_desc1": "Arcane aura 2 dmg/s in 120 radius, arcane",
    "powerup_arcane_aura_desc2": "Arcane aura 4 dmg/s in 160 radius, arcane",
    "powerup_arcane_aura_desc3": "Arcane aura 8 dmg/s in 200 radius, arcane",
    ...
    "powerup_arcane_mastery_desc": "Arcane effects: +150% dmg, +100% duration, piercing",
    "powerup_lightning_mastery_desc": "Lightning effects: +150% dmg, +100% duration, +25% slow, +1 chain, +50% range",
    "powerup_wind_mastery_desc": "Wind effects: +150% dmg, +100% duration, +40% slow, stronger push",
    "powerup_parry_desc": "Active: Invincible for 0.5s, bounce enemy bullets (5s cooldown)",
    "powerup_blood_orb_desc1": "2 blood orbs (1.5 dmg/hit, lifesteal)",
    "powerup_blood_orb_desc2": "4 blood orbs (2 dmg/hit, lifesteal)",
    "powerup_blood_orb_desc3": "6 blood orbs (2.5 dmg/hit, lifesteal)",
    "powerup_blood_aura_desc1": "Blood aura 1.5 dmg/s in 120 radius, heal 2.5% dealt",
    "powerup_blood_aura_desc2": "Blood aura 3 dmg/s in 160 radius, heal 5% dealt",
    "powerup_blood_aura_desc3": "Blood aura 6 dmg/s in 200 radius, heal 10% dealt",
    "powerup_blood_mastery_desc": "Blood effects: +150% dmg, +100% duration, +50% lifesteal",
    "powerup_radial_burst_desc1": "Fire 8 bullets in a circle every 4s",
  ...
  Spanish: {
    ...
    "shop_wall_x5": "Muro (x5)",
    "shop_wall_x5_desc": "Comprar 5 muros desplegables",
    ...
    "powerup_overcharge": "Ímpetu",
    "powerup_echo_shots": "Golpe Eco",
    ...
    "powerup_rotating_shield_desc1": "3 escudos (30% cobertura, 3 HP, 4s reaparición)",
    "powerup_rotating_shield_desc2": "3 escudos (35% cobertura, 4 HP, 3s reaparición)",
    "powerup_rotating_shield_desc3": "3 escudos (40% cobertura, 5 HP, 2s reaparición)",
    ...
    "powerup_magical_bullets_desc": "Balas rastrean enemigo más cercano",
    ...
    "powerup_explosive_bullets_desc1": "Balas explotan (radio pequeño)",
    "powerup_explosive_bullets_desc2": "Balas explotan (radio mediano)",
    "powerup_explosive_bullets_desc3": "Balas explotan (radio grande)",
    ...
    "powerup_time_warp_desc": "Ralentizar tiempo 50% por 4s (2 usos/oleada, 18s cd)",
    ...
    "powerup_overcharge_desc": "+5% daño por 100 unidades recorridas (max 100%, rango 80)",
    "powerup_echo_shots_desc": "Balas dejan rastro fantasma (50% daño)",
    "powerup_rotating_orbs_desc": "Los 6 orbes elementales (2.5 daño/golpe)",
    ...
    "powerup_lightning_orb_desc1": "2 orbes rayo (1.5 daño/golpe)",
    "powerup_lightning_orb_desc2": "4 orbes rayo (2 daño/golpe)",
    "powerup_lightning_orb_desc3": "6 orbes rayo (2.5 daño/golpe)",
    "powerup_wind_orb_desc1": "2 orbes viento (1 daño/golpe, empuje)",
    "powerup_wind_orb_desc2": "4 orbes viento (1.5 daño/golpe, empuje)",
    "powerup_wind_orb_desc3": "6 orbes viento (2 daño/golpe, empuje)",
    "powerup_frost_orb_desc1": "2 orbes hielo (1 daño/golpe, ralentizar)",
    "powerup_frost_orb_desc2": "4 orbes hielo (1.5 daño/golpe, ralentizar)",
    "powerup_frost_orb_desc3": "6 orbes hielo (2 daño/golpe, ralentizar)",
    "powerup_arcane_orb_desc1": "2 orbes arcanos (1.5 daño/golpe, arcano)",
    "powerup_arcane_orb_desc2": "4 orbes arcanos (2 daño/golpe, arcano)",
    "powerup_arcane_orb_desc3": "6 orbes arcanos (2.5 daño/golpe, arcano)",
    "powerup_arcane_bullets_desc1": "Balas mejoradas con poder arcano (+50% daño bala, arcano)",
    "powerup_arcane_bullets_desc2": "Balas mejoradas con poder arcano (+100% daño bala, arcano)",
    "powerup_arcane_bullets_desc3": "Balas mejoradas con poder arcano (+150% daño bala, arcano)",
    ...
    "powerup_arcane_mastery_desc": "Efectos arcanos: +150% daño, +100% duración, perforación",
    "powerup_lightning_mastery_desc": "Efectos rayo: +150% daño, +100% duración, +25% ralentización, +1 cadena, +50% rango",
    "powerup_wind_mastery_desc": "Efectos viento: +150% daño, +100% duración, +40% ralentización, empuje más fuerte",
    "powerup_parry_desc": "Activo: Invencible por 0.5s, rebota balas enemigas (5s enfriamiento)",
    "powerup_blood_orb_desc1": "2 orbes sangre (1.5 daño/golpe, robo vida)",
    "powerup_blood_orb_desc2": "4 orbes sangre (2 daño/golpe, robo vida)",
    "powerup_blood_orb_desc3": "6 orbes sangre (2.5 daño/golpe, robo vida)",
    ...
    "powerup_radial_burst_desc1": "Disparar 8 balas en círculo cada 4s",
