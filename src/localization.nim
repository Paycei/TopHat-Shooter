...
var translations: Table[localization.Language, Table[system.string, system.string]] = {
  English: {
    ...
    "powerup_fire_aura_desc1": "Burn enemies {0} dmg/s in 188 radius (2s)",
    "powerup_fire_aura_desc2": "Burn enemies {0} dmg/s in 250 radius (3s)",
    "powerup_fire_aura_desc3": "Burn enemies {0} dmg/s in 313 radius (4s)",
    "powerup_lightning_aura_desc1": "Zap {0} dmg/s in 188 radius (chains 1x)",
    "powerup_lightning_aura_desc2": "Zap {0} dmg/s in 250 radius (chains 2x)",
    "powerup_lightning_aura_desc3": "Zap {0} dmg/s in 313 radius (chains 3x)",
    ...
    "powerup_arcane_aura_desc1": "Arcane aura {0} dmg/s in 188 radius, arcane",
    "powerup_arcane_aura_desc2": "Arcane aura {0} dmg/s in 250 radius, arcane",
    "powerup_arcane_aura_desc3": "Arcane aura {0} dmg/s in 313 radius, arcane",
