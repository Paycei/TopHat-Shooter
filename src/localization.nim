...
var translations: Table[localization.Language, Table[system.string, system.string]] = {
  ...
  Spanish: {
    ...
    "powerup_volatile_desc": "Enemigos con 2+ elementos reciben +50% daño de bala; al morir pulsan sus elementos activos a enemigos cercanos",
    ...
    "powerup_aftershock_desc": "Emite una onda por tus últimos 2s de movimiento, daña y empuja a los enemigos golpeados. Recarga 14s",
    "powerup_nova": "Nova",
