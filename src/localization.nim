...
var translations: Table[localization.Language, Table[system.string, system.string]] = {
  English: {
    ...
    "powerup_volatile_desc": "Enemies with 2+ elements take +50% bullet dmg and on death release a pulse that applies their active elements and remaining durations to nearby foes",
    ...
    "powerup_aftershock_desc": "Emit a shockwave tracing your last 2s of movement, dealing area damage along the path, strongly knocking back and briefly staggering enemies hit. 14s cooldown",
    "powerup_nova": "Nova",
  ...
  Spanish: {
    ...
    "powerup_volatile_desc": "Enemigos con 2+ elementos reciben +50% de daño de bala y al morir emiten un pulso que aplica sus elementos activos y su duración restante a enemigos cercanos",
    ...
    "powerup_blood_pact_desc": "Sacrifica 30% de tu HP actual y divide ese daño entre todos los enemigos en pantalla. Recarga 15s",
    "powerup_conduit": "Conducto",
    "powerup_conduit_desc": "Detona todos los DoTs activos en los enemigos por 3x su daño restante y luego los elimina. Recarga 15s",
    "powerup_aftershock": "Réplica",
    "powerup_aftershock_desc": "Emite una onda de choque que traza tus últimos 2s de movimiento, inflige daño de área a lo largo del camino, empuja con fuerza y aturde brevemente a los enemigos alcanzados. Recarga 14s",
    "powerup_nova": "Nova",
    "powerup_nova_desc": "Congela todas tus balas en su lugar por 2 segundos y luego las libera juntas a 1.5x velocidad. Recarga 16s",
