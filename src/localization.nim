...
var translations: Table[localization.Language, Table[system.string, system.string]] = {
  English: {
    ...
    "shop_damage_plus_desc": "Boost bullet damage",
    "shop_fire_rate_plus": "Fire Rate +",
    "shop_fire_rate_plus_desc": "Improve rate of fire",
    "shop_move_speed_plus": "Move Speed +",
    "shop_move_speed_plus_desc": "Boost movement speed",
    "shop_max_health_plus": "Max Health +",
    "shop_max_health_plus_desc": "Increase max HP",
    "shop_bullet_speed_plus": "Bullet Speed +",
    "shop_bullet_speed_plus_desc": "Boost bullet velocity",
    ...
    "powerup_blood_bullets_desc2": "Heal 2.0% of bullet damage (blood element)",
    "powerup_blood_bullets_desc3": "Heal 2.75% of bullet damage (blood element)",
    ...
    "powerup_arcane_mastery_desc": "Arcane bullets: +60% dmg, piercing; aura/orbs: +100% dmg",
    ...
    # Help System - Shop items
    "help_shop_damage_plus": "Damage + (9 CR base)",
    "help_shop_damage_plus_desc": "Boost bullet damage",
    "help_shop_fire_rate_plus": "Fire Rate + (9 CR base)",
    "help_shop_fire_rate_plus_desc": "Improve rate of fire",
    "help_shop_move_speed_plus": "Move Speed + (7 CR base)",
    "help_shop_move_speed_plus_desc": "Boost movement speed",
    ...
    "help_shop_bullet_speed_plus_desc": "Boost bullet velocity",
    ...
    "gamemode_roguelite_desc": "Pick risk routes, draft unlocked power families, defeat 3 act bosses, and bank shards.",
    "roguelite_setup_title": "ROGUELITE SETUP",
    "roguelite_sector_title": "CHOOSE SECTOR",
    "roguelite_unlocks_title": "SHARD UNLOCKS",
    "roguelite_data_shards": "Data Shards",
    "roguelite_shards": "Shards",
    "roguelite_heat": "Heat",
    "roguelite_act": "Act",
    "roguelite_sector": "Sector",
    "roguelite_sectors": "Sectors",
    "roguelite_endless": "Endless",
    "roguelite_waves": "Waves",
    ...
    "roguelite_unlock_shop_hint": "Spend shards here. Purchases expand future drafts, relics, and Heat.",
    ...
    "roguelite_not_enough_shards": "NEED SHARDS",
    "roguelite_buy_unlock": "[ENTER] BUY",
    "roguelite_need_more_shards": "NEED SHARDS",
    "roguelite_already_unlocked": "OWNED",
    "roguelite_unlock_heat": "Heat",
    "roguelite_unlock_boss_tier": "Boss Pool",
    ...
    "roguelite_unlock_desc_shard": "Relic: +25% shards from waves and sector clears.",
    "roguelite_unlock_desc_draft": "Relic: rerolls cost 10 fewer credits after other discounts.",
    "roguelite_unlock_desc_patch": "Relic: each act boss heals 2 HP and grants +1 shield charge.",
    "roguelite_unlock_desc_elite": "Relic: elite sectors grant +25 credits and bonus shards.",
    "roguelite_unlock_desc_heat": "Unlocks the next Heat. Each Heat adds +18% pressure and +5 elite chance.",
    "roguelite_unlock_desc_boss_tier": "Unlocks harder act boss pools for later runs.",
    "roguelite_starter_ready": "READY",
    "roguelite_boss": "Boss",
    "roguelite_boss_tier": "Boss Pool",
    "roguelite_run_flow": "ACT ROUTE",
    "roguelite_sector_tip": "Higher risk means more pressure, more elites, and bigger shard payouts.",
    "roguelite_combat_title": "ROGUELITE SECTOR",
    "roguelite_sector_wave": "Wave",
    "roguelite_objective_clear": "Clear wave",
    "roguelite_objective_draft": "Next: Draft",
    "roguelite_objective_boss": "Next: Act Boss",
    "roguelite_objective_choose": "Next: Sector",
    "roguelite_heat_effects": "Effects",
    "roguelite_heat_unlock_first": "Buy Heat 1 in Unlocks.",
    "roguelite_heat_unlock_next": "Buy Heat",
    "roguelite_heat_buy_next": "Buy Heat",
    "roguelite_heat_maxed": "Heat fully unlocked",
    "roguelite_heat_unlock_rule": "Heat is bought with shards. Each tier adds pressure, elites, faster spawns, and tougher bosses.",
    "roguelite_req_default": "Default",
    "roguelite_req_35_act2": "35 shards or Act 2",
    "roguelite_req_75_act3": "75 shards or Act 3",
    ...
    "roguelite_modifier_safehouse": "Safehouse",
    "roguelite_modifier_overclocked": "Overclocked",
    "roguelite_modifier_elite_cache": "Elite Cache",
    "roguelite_modifier_firewall": "Firewall",
    "roguelite_modifier_volatile": "Volatile Memory",
    "roguelite_modifier_black_market": "Black Market",
    "roguelite_modifier_safehouse_desc": "Low pressure, lower shards, credit reward.",
    "roguelite_modifier_overclocked_desc": "+28% pressure, +5 elite chance, +18% shards.",
    "roguelite_modifier_elite_cache_desc": "+38% pressure, +26 elite chance, +35% shards.",
    "roguelite_modifier_firewall_desc": "+22% pressure, +8 elite chance, +15% shards.",
    "roguelite_modifier_volatile_desc": "+50% pressure, +16 elite chance, +48% shards.",
    "roguelite_modifier_black_market_desc": "+16% pressure, +4 elite chance, bonus credits.",
    "roguelite_reward_credits": "Credits",
    "roguelite_reward_relic": "Relic",
    "roguelite_reward_family": "Family Draft",
  ...
  Spanish: {
    ...
    "shop_damage_plus_desc": "Mejora el daño de las balas",
    "shop_fire_rate_plus": "Cadencia +",
    "shop_fire_rate_plus_desc": "Mejora la cadencia de disparo",
    "shop_move_speed_plus": "Velocidad +",
    "shop_move_speed_plus_desc": "Mejora la velocidad de movimiento",
    "shop_max_health_plus": "Vida Máx +",
    "shop_max_health_plus_desc": "Aumenta la vida máxima",
    "shop_bullet_speed_plus": "Vel. Balas +",
    "shop_bullet_speed_plus_desc": "Mejora la velocidad de las balas",
    "shop_wall_x4": "Muro (x4)",
    "shop_wall_x4_desc": "Compra 4 muros desplegables",
    ...
    "powerup_blood_bullets_desc1": "Restaura el 1.5% del daño de bala (sangre)",
    "powerup_blood_bullets_desc2": "Restaura el 2.0% del daño de bala (sangre)",
    "powerup_blood_bullets_desc3": "Restaura el 2.75% del daño de bala (sangre)",
    ...
    "powerup_slow_field_desc1": "Ralentiza a los enemigos un 30% en radio 120",
    "powerup_slow_field_desc2": "Ralentiza a los enemigos un 45% en radio 160",
    "powerup_slow_field_desc3": "Ralentiza a los enemigos un 55% en radio 200",
    ...
    "powerup_rotating_orbs_desc": "Obtienes los 6 orbes elementales ({0} daño/golpe)",
    ...
    "powerup_arcane_mastery_desc": "Balas arcanas: +60% daño, perforación; aura/orbes: +100% daño",
    ...
    "powerup_blood_aura_desc1": "Aura de sangre: {0} daño/s en radio 120 y cura un 2.5% del daño infligido",
    "powerup_blood_aura_desc2": "Aura de sangre: {0} daño/s en radio 160 y cura un 5% del daño infligido",
    "powerup_blood_aura_desc3": "Aura de sangre: {0} daño/s en radio 200 y cura un 10% del daño infligido",
    ...
    # Help System - Shop items
    "help_shop_damage_plus": "Daño + (9 CR base)",
    "help_shop_damage_plus_desc": "Mejora el daño de las balas",
    "help_shop_fire_rate_plus": "Cadencia + (9 CR base)",
    "help_shop_fire_rate_plus_desc": "Mejora la cadencia de disparo",
    "help_shop_move_speed_plus": "Velocidad de Movimiento + (7 CR base)",
    "help_shop_move_speed_plus_desc": "Mejora la velocidad de movimiento",
    "help_shop_max_health_plus": "Salud Máxima + (10 CR base)",
    "help_shop_max_health_plus_desc": "Aumenta la vida máxima",
    "help_shop_bullet_speed_plus": "Velocidad de Bala + (6 CR base)",
    "help_shop_bullet_speed_plus_desc": "Mejora la velocidad de las balas",
    ...
    "gamemode_roguelite_name": "Roguelite",
    "gamemode_roguelite_desc": "Elige rutas de riesgo, compra familias de mejoras, vence 3 jefes y guarda fragmentos.",
    "roguelite_setup_title": "AJUSTE ROGUELITE",
    "roguelite_sector_title": "ELIGE SECTOR",
    ...
    "roguelite_unlocks": "[U] Mejoras",
    "roguelite_start": "[ENTER] Iniciar",
    "roguelite_back": "[ESC] Volver",
    "roguelite_setup_controls": "Kit A/D  |  Calor W/S  |  Mejoras U  |  Iniciar ENTER",
    "roguelite_sector_controls": "Sector A/D  |  Entrar ENTER",
    "roguelite_unlock_controls": "Volver ESC/U",
    "roguelite_unlock_shop_controls": "Grupo TAB/A-D  |  Item W/S  |  Comprar ENTER  |  Volver ESC",
    "roguelite_unlock_shop_hint": "Gasta fragmentos aqui. Las compras amplian futuros drafts, reliquias y Calor.",
    ...
    "roguelite_not_enough_shards": "FALTAN FRAG.",
    "roguelite_buy_unlock": "[ENTER] COMPRAR",
    "roguelite_need_more_shards": "FALTAN FRAG.",
    "roguelite_already_unlocked": "COMPRADO",
    "roguelite_unlock_heat": "Calor",
    "roguelite_unlock_boss_tier": "Pool Jefes",
    ...
    "roguelite_unlock_desc_heat": "Desbloquea el siguiente Calor. Cada Calor suma +18% presion y +5 elite.",
    "roguelite_unlock_desc_boss_tier": "Desbloquea pools de jefes mas duros para futuras runs.",
    "roguelite_starter_ready": "LISTO",
    "roguelite_boss": "Jefe",
    "roguelite_boss_tier": "Pool Jefes",
    ...
    "roguelite_modifier_safehouse_desc": "Baja presion, menos fragmentos, paga creditos.",
    "roguelite_modifier_overclocked_desc": "+28% presion, +5 elite, +18% fragmentos.",
    "roguelite_modifier_elite_cache_desc": "+38% presion, +26 elite, +35% fragmentos.",
    "roguelite_modifier_firewall_desc": "+22% presion, +8 elite, +15% fragmentos.",
    "roguelite_modifier_volatile_desc": "+50% presion, +16 elite, +48% fragmentos.",
    "roguelite_modifier_black_market_desc": "+16% presion, +4 elite, creditos extra.",
