...
var translations: Table[localization.Language, Table[system.string, system.string]] = {
  ...
  Spanish: {
    ...
    "shop_damage_plus_desc": "Aumenta el daño de las balas",
    "shop_fire_rate_plus": "Cadencia +",
    "shop_fire_rate_plus_desc": "Aumenta la cadencia",
    "shop_move_speed_plus": "Velocidad +",
    "shop_move_speed_plus_desc": "Aumenta la velocidad de movimiento",
    "shop_max_health_plus": "Vida Máx +",
    "shop_max_health_plus_desc": "Aumenta la vida máxima",
    "shop_bullet_speed_plus": "Vel. Balas +",
    "shop_bullet_speed_plus_desc": "Aumenta la velocidad de las balas",
    ...
    "powerup_multi_shot_desc": "Dispara en 3 direcciones",
    ...
    "powerup_blood_bullets_desc1": "Restaura el 1.75% del daño de bala (sangre)",
    "powerup_blood_bullets_desc2": "Restaura el 2.25% del daño de bala (sangre)",
    "powerup_blood_bullets_desc3": "Restaura el 3% del daño de bala (sangre)",
    ...
    "powerup_arcane_bullets_desc1": "Balas arcanas mejoradas (+40% daño de bala, arcano)",
    "powerup_arcane_bullets_desc2": "Balas arcanas mejoradas (+80% daño de bala, arcano)",
    "powerup_arcane_bullets_desc3": "Balas arcanas mejoradas (+120% daño de bala, arcano)",
    ...
    "help_shop_damage_plus_desc": "Aumenta el daño de las balas",
    "help_shop_fire_rate_plus": "Cadencia + (10 CR base)",
    "help_shop_fire_rate_plus_desc": "Aumenta la cadencia",
    "help_shop_move_speed_plus": "Velocidad de Movimiento + (7 CR base)",
    "help_shop_move_speed_plus_desc": "Aumenta la velocidad de movimiento",
    ...
    "help_shop_bullet_speed_plus_desc": "Aumenta la velocidad de las balas",
