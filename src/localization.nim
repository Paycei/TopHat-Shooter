...
var translations: Table[localization.Language, Table[system.string, system.string]] = {
  English: {
    ...
    "powerup_fire_aura_desc1": "Burn enemies {0} dmg/s in 120 radius (2s)",
    "powerup_fire_aura_desc2": "Burn enemies {0} dmg/s in 160 radius (3s)",
    "powerup_fire_aura_desc3": "Burn enemies {0} dmg/s in 200 radius (4s)",
    "powerup_lightning_aura_desc1": "Zap {0} dmg/s in 120 radius (chains 1x)",
    "powerup_lightning_aura_desc2": "Zap {0} dmg/s in 160 radius (chains 2x)",
    "powerup_lightning_aura_desc3": "Zap {0} dmg/s in 200 radius (chains 3x)",
    "powerup_poison_aura_desc1": "Poison {0} dmg/s in 120 radius (6s duration)",
    "powerup_poison_aura_desc2": "Poison {0} dmg/s in 160 radius (8s duration)",
    "powerup_poison_aura_desc3": "Poison {0} dmg/s in 200 radius (10s duration)",
    ...
    "powerup_arcane_aura_desc1": "Arcane aura {0} dmg/s in 120 radius, arcane",
    "powerup_arcane_aura_desc2": "Arcane aura {0} dmg/s in 160 radius, arcane",
    "powerup_arcane_aura_desc3": "Arcane aura {0} dmg/s in 200 radius, arcane",
    ...
    "powerup_blood_aura_desc1": "Blood aura {0} dmg/s in 120 radius, heal 2.5% dealt",
    "powerup_blood_aura_desc2": "Blood aura {0} dmg/s in 160 radius, heal 5% dealt",
    "powerup_blood_aura_desc3": "Blood aura {0} dmg/s in 200 radius, heal 10% dealt",
