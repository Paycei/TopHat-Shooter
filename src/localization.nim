...
var translations: Table[localization.Language, Table[system.string, system.string]] = {
  English: {
    ...
    "roguelite_overheat_cores": "Overheat Cores",
    "roguelite_singularity_cores": "Singularity Cores",
    "roguelite_overheat_short": "OH",
    "roguelite_singularity_short": "SG",
    "roguelite_heat": "Heat",
    "roguelite_act": "Act",
    ...
    "roguelite_unlock_desc_heat": "Unlocks the next Heat above the default. Heat 3 costs Overheat Cores earned on Heat 2+.",
    ...
    "roguelite_heat_core_rule": "Heat 2+ drops Overheat Cores. Heat 3 drops Singularity Cores.",
    ...
    "roguelite_modifier_safehouse_desc": "Low pressure and reliable credits.",
    "roguelite_modifier_overclocked_desc": "+18% pressure, +4 elite chance, +22% shards.",
    "roguelite_modifier_elite_cache_desc": "+25% pressure, +18 elite chance, +45% shards.",
    "roguelite_modifier_firewall_desc": "+14% pressure, +6 elite chance, +18% shards.",
    "roguelite_modifier_volatile_desc": "+32% pressure, +12 elite chance, +55% shards.",
    "roguelite_modifier_black_market_desc": "+10% pressure, +3 elite chance, bonus credits.",
