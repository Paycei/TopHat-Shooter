...
var translations: Table[localization.Language, Table[system.string, system.string]] = {
  English: {
    ...
    "powerup_overcharge_desc": "+10% dmg per 100 units traveled (max 100%, reaches at 1000 units)",
  ...
  Spanish: {
    ...
    "powerup_overcharge_desc": "+10% daño por 100 unidades recorridas (max 100%, rango 1000)",
