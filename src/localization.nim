...
var translations: Table[localization.Language, Table[system.string, system.string]] = {
  English: {
    ...
    "powerup_poison_aura_desc1": "Poison enemies {0} in 188 radius (6s, stacks over time)",
    "powerup_poison_aura_desc2": "Poison enemies {0} in 250 radius (8s, stacks over time)",
    "powerup_poison_aura_desc3": "Poison enemies {0} in 313 radius (10s, stacks over time)",
    ...
    "powerup_fire_mastery_desc": "Fire effects: +350% dmg, +50% duration, +45% slow",
  ...
  Spanish: {
    ...
    "powerup_poison_aura_desc1": "Veneno {0} daño/s en radio 188 (6s, acumulable)",
    "powerup_poison_aura_desc2": "Veneno {0} daño/s en radio 250 (8s, acumulable)",
    "powerup_poison_aura_desc3": "Veneno {0} daño/s en radio 313 (10s, acumulable)",
    ...
    "powerup_fire_mastery_desc": "Fuego: +350% daño, +50% duración y +45% ralentización",
